...
public class DataFlowSchemaReorientCommand extends EditElementCommand {
	...
	*/
	protected boolean canReorientSource() {
		...
		return PipelineBaseItemSemanticEditPolicy.getLinkConstraints().canExistDataFlowSchema_4003(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return PipelineBaseItemSemanticEditPolicy.getLinkConstraints().canExistDataFlowSchema_4003(getOldSource(),
				getNewTarget());
	}
