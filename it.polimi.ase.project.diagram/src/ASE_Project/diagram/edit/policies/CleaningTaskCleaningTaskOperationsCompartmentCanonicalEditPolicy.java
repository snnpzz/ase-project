...
public class CleaningTaskCleaningTaskOperationsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return ASE_Project.ASE_ProjectPackage.eINSTANCE.getCleaningTask_Operations();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ASE_Project.diagram.part.ASE_ProjectNodeDescriptor> childDescriptors = ASE_Project.diagram.part.ASE_ProjectDiagramUpdater
				.getCleaningTaskCleaningTaskOperationsCompartment_7002SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == ASE_Project.diagram.edit.parts.UserDefinedEditPart.VISUAL_ID
				|| visualID == ASE_Project.diagram.edit.parts.PredefinedEditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<ASE_Project.diagram.part.ASE_ProjectNodeDescriptor> childDescriptors = ASE_Project.diagram.part.ASE_ProjectDiagramUpdater
				.getCleaningTaskCleaningTaskOperationsCompartment_7002SemanticChildren((View) getHost().getModel());
