...
public class VisualizationTaskEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ASEProject.diagram.edit.policies.VisualizationTaskItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ASEProject.diagram.edit.parts.VisualizationTaskNameEditPart) {
			((ASEProject.diagram.edit.parts.VisualizationTaskNameEditPart) childEditPart)
