...
/**
 * This is the item provider adapter for a {@link ASEProject.Attribute} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AttributeItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ASEProjectPackage.Literals.ATTRIBUTE__NAME,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ASEProjectPackage.Literals.ATTRIBUTE__TYPE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addNextPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_next_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_next_feature", "_UI_Attribute_type"),
				 ASEProjectPackage.Literals.ATTRIBUTE__NEXT,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addPreviousPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Attribute_previous_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Attribute_previous_feature", "_UI_Attribute_type"),
				 ASEProjectPackage.Literals.ATTRIBUTE__PREVIOUS,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ASEProjectPackage.Literals.ATTRIBUTE__ATTRIBUTES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ASEProjectPackage.Literals.ATTRIBUTE__ATTRIBUTES,
				 ASEProjectFactory.eINSTANCE.createAttribute()));
	}
