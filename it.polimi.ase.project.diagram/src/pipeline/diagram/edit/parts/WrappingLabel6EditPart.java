...
public class WrappingLabel6EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				PipelineVisualIDRegistry.getType(pipeline.diagram.edit.parts.WrappingLabel6EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineParserProvider.getParser(PipelineElementTypes.ExportExpUses_4014, getParserElement(),
