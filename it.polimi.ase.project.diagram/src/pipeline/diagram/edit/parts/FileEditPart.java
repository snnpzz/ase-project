...
import pipeline.diagram.edit.policies.FileItemSemanticEditPolicy;
...
public class FileEditPart extends ShapeNodeEditPart {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PipelineVisualIDRegistry.getType(FileNameEditPart.VISUAL_ID));
	}
