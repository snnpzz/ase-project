...
public class VisualizationTaskEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ASE_Project.diagram.edit.policies.VisualizationTaskItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ASE_Project.diagram.edit.parts.VisualizationTaskNameEditPart) {
			((ASE_Project.diagram.edit.parts.VisualizationTaskNameEditPart) childEditPart)
