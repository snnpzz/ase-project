 ...
 * @generated
 */
public class ClassificationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ClassificationNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ASE_Project.diagram.providers.ASE_ProjectParserProvider.getParser(
					ASE_Project.diagram.providers.ASE_ProjectElementTypes.Classification_3005, getParserElement(),
