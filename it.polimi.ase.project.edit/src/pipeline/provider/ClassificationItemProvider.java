...
/**
 * This is the item provider adapter for a {@link pipeline.Classification} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClassificationItemProvider extends AnalysisOperationItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 PipelinePackage.Literals.CLASSIFICATION__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		ClassificationOperation labelValue = ((Classification)object).getName();
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Classification.class)) {
			case PipelinePackage.CLASSIFICATION__NAME:
