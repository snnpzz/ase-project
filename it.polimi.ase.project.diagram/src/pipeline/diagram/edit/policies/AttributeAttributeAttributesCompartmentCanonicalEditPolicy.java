 ...
 * @generated
 */
public class AttributeAttributeAttributesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineNodeDescriptor> childDescriptors = PipelineDiagramUpdater
				.getAttributeAttributeAttributesCompartment_7024SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineNodeDescriptor> childDescriptors = PipelineDiagramUpdater
				.getAttributeAttributeAttributesCompartment_7024SemanticChildren((View) getHost().getModel());
