		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Operation_previous_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Operation_previous_feature", "_UI_Operation_type"),
				 ASEProjectPackage.Literals.OPERATION__PREVIOUS,
				 true,
				 false,
				 true,
				 null,
