 ...
 * @generated
 */
public class ASEProjectValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	* @generated
	*/
	private static final String MARKER_TYPE = ASEProject.diagram.part.ASEProjectDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
	...
	*/
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof ASEProject.diagram.part.ASEProjectDiagramEditor) {
	...
	*/
	public boolean provides(IOperation operation) {
		...
		return view != null && ASEProject.diagram.edit.parts.PipelineEditPart.MODEL_ID
		...
		*/
		public StatusDecorator(IDecoratorTarget decoratorTarget) {
			...
			try {
				...
				ASEProject.diagram.part.ASEProjectDiagramEditorPlugin.getInstance().logError("ViewID access failure", //$NON-NLS-1$
						e);
			}
		}
