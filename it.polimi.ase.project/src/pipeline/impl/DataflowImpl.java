...
public class DataflowImpl extends EObjectImpl implements Dataflow {
	...
	protected EClass eStaticClass() {
		return PipelinePackage.Literals.DATAFLOW;
	}
	...
	public void setFormat(Format newFormat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PipelinePackage.DATAFLOW__FORMAT, oldFormat, format));
	}
	...
	public NotificationChain basicSetSchema(Schema newSchema, NotificationChain msgs) {
		...
		schema = newSchema;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PipelinePackage.DATAFLOW__SCHEMA, oldSchema, newSchema);
	...
	public void setSchema(Schema newSchema) {
		if (newSchema != schema) {
			...
			if (schema != null)
				msgs = ((InternalEObject)schema).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - PipelinePackage.DATAFLOW__SCHEMA, null, msgs);
			if (newSchema != null)
				msgs = ((InternalEObject)newSchema).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - PipelinePackage.DATAFLOW__SCHEMA, null, msgs);
			msgs = basicSetSchema(newSchema, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, PipelinePackage.DATAFLOW__SCHEMA, newSchema, newSchema));
	}
	...
	public Task getTarget() {
		if (target != null && target.eIsProxy()) {
			...
			if (target != oldTarget) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PipelinePackage.DATAFLOW__TARGET, oldTarget, target));
			}
		}
		return target;
	}
	...
	public NotificationChain basicSetTarget(Task newTarget, NotificationChain msgs) {
		...
		target = newTarget;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PipelinePackage.DATAFLOW__TARGET, oldTarget, newTarget);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setTarget(Task newTarget) {
		if (newTarget != target) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PipelinePackage.DATAFLOW__TARGET, newTarget, newTarget));
	}
	...
	public Task getSource() {
		if (source != null && source.eIsProxy()) {
			...
			if (source != oldSource) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, PipelinePackage.DATAFLOW__SOURCE, oldSource, source));
			}
		}
		return source;
	}
	...
	public NotificationChain basicSetSource(Task newSource, NotificationChain msgs) {
		...
		source = newSource;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, PipelinePackage.DATAFLOW__SOURCE, oldSource, newSource);
			if (msgs == null) msgs = notification; else msgs.add(notification);
		}
		return msgs;
	}
	...
	public void setSource(Task newSource) {
		if (newSource != source) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PipelinePackage.DATAFLOW__SOURCE, newSource, newSource));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case PipelinePackage.DATAFLOW__TARGET:
				if (target != null)
					msgs = ((InternalEObject)target).eInverseRemove(this, PipelinePackage.TASK__INCOMING, Task.class, msgs);
				return basicSetTarget((Task)otherEnd, msgs);
			case PipelinePackage.DATAFLOW__SOURCE:
				if (source != null)
					msgs = ((InternalEObject)source).eInverseRemove(this, PipelinePackage.TASK__OUTGOING, Task.class, msgs);
