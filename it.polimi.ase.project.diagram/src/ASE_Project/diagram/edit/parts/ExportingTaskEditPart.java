...
public class ExportingTaskEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ASE_Project.diagram.edit.policies.ExportingTaskItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ASE_Project.diagram.edit.parts.ExportingTaskNameEditPart) {
			((ASE_Project.diagram.edit.parts.ExportingTaskNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureExportingTaskLabelFigure());
			return true;
		}
		if (childEditPart instanceof ASE_Project.diagram.edit.parts.ExportingTaskExportingTaskExportsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getExportingTaskExportsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(
					((ASE_Project.diagram.edit.parts.ExportingTaskExportingTaskExportsCompartmentEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ASE_Project.diagram.edit.parts.ExportingTaskExportingTaskExportsCompartmentEditPart) {
