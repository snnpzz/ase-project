 ...
 * @generated
 */
public class PredefinedCleaningOperationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PredefinedCleaningOperationNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineParserProvider.getParser(PipelineElementTypes.PredefinedCleaningOperation_3003,
					getParserElement(), PipelineVisualIDRegistry
							.getType(pipeline.diagram.edit.parts.PredefinedCleaningOperationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
