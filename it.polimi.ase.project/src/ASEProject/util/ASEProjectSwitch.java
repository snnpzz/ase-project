 ...
 * @generated
 */
public class ASEProjectSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case ASEProjectPackage.PIPELINE: {
				Pipeline pipeline = (Pipeline)theEObject;
				T result = casePipeline(pipeline);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ASEProjectPackage.TASK: {
				Task task = (Task)theEObject;
				T result = caseTask(task);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ASEProjectPackage.DATAFLOW: {
			...
			case ASEProjectPackage.SCHEMA: {
				Schema schema = (Schema)theEObject;
				T result = caseSchema(schema);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ASEProjectPackage.ATTRIBUTE: {
				Attribute attribute = (Attribute)theEObject;
				T result = caseAttribute(attribute);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ASEProjectPackage.COLLECTION_TASK: {
			...
			case ASEProjectPackage.INTEGRATION_TASK: {
			...
			case ASEProjectPackage.CLEANING_TASK: {
			...
			case ASEProjectPackage.ANALYZES_TASK: {
			...
			case ASEProjectPackage.VISUALIZATION_TASK: {
			...
			case ASEProjectPackage.EXPORTING_TASK: {
			...
			case ASEProjectPackage.USER_DEFINED: {
			...
			case ASEProjectPackage.SOURCE: {
				Source source = (Source)theEObject;
				T result = caseSource(source);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ASEProjectPackage.FILE: {
				File file = (File)theEObject;
				T result = caseFile(file);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case ASEProjectPackage.CLEANING_OP: {
			...
			case ASEProjectPackage.ANALYSIS_OP: {
			...
			case ASEProjectPackage.DESCRIPTIVE: {
			...
			case ASEProjectPackage.CLASSIFICATION: {
			...
			case ASEProjectPackage.PREDICTIVE: {
			...
			case ASEProjectPackage.CLUSTERING: {
			...
			case ASEProjectPackage.PREDEFINED: {
