 ...
 * @generated
 */
public class VisualizationTaskIDEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public VisualizationTaskIDEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineParserProvider.getParser(PipelineElementTypes.VisualizationTask_2005, getParserElement(),
					PipelineVisualIDRegistry
							.getType(pipeline.diagram.edit.parts.VisualizationTaskIDEditPart.VISUAL_ID));
		}
		return parser;
	}
