 ...
 * @generated
 */
public class ExportOperationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ExportOperationNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = PipelineParserProvider.getParser(PipelineElementTypes.ExportOperation_3014, getParserElement(),
					PipelineVisualIDRegistry
							.getType(pipeline.diagram.edit.parts.ExportOperationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
