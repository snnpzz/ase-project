...
/**
 * This is the item provider adapter for a {@link pipeline.Clustering} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ClusteringItemProvider extends AnalysisOperationItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Clustering_k_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Clustering_k_feature", "_UI_Clustering_type"),
				 PipelinePackage.Literals.CLUSTERING__K,
				 true,
				 false,
				 false,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/Clustering"));
	}
