 ...
 * @generated
 */
public class UserDefinedName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public UserDefinedName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineParserProvider.getParser(PipelineElementTypes.UserDefined_3026, getParserElement(),
					PipelineVisualIDRegistry.getType(pipeline.diagram.edit.parts.UserDefinedName2EditPart.VISUAL_ID));
		}
		return parser;
	}
