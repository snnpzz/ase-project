...
public class DataFlowCreateCommand extends EditElementCommand {
	...
	*/
	public boolean canExecute() {
		...
		return PipelineBaseItemSemanticEditPolicy.getLinkConstraints().canCreateDataFlow_4005(getContainer(),
				getSource(), getTarget());
	}
	...
	*/
	protected CommandResult doExecuteWithResult(IProgressMonitor monitor, IAdaptable info) throws ExecutionException {
		...
		DataFlow newElement = PipelineFactory.eINSTANCE.createDataFlow();
