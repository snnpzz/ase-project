 ...
 * @generated
 */
public class ImportOperationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ImportOperationNameEditPart(View view) {
		super(view);
	}
		...
		if (parser == null) {
			parser = PipelineParserProvider.getParser(PipelineElementTypes.ImportOperation_3013, getParserElement(),
					PipelineVisualIDRegistry
							.getType(pipeline.diagram.edit.parts.ImportOperationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
