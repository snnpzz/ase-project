 ...
 * @generated
 */
public class CollectionTaskCollectionTaskImportOperationsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PipelinePackage.eINSTANCE.getCollectionTask_ImportOperations();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineNodeDescriptor> childDescriptors = PipelineDiagramUpdater
				.getCollectionTaskCollectionTaskImportOperationsCompartment_7001SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return ImportOperationEditPart.VISUAL_ID == PipelineVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineNodeDescriptor> childDescriptors = PipelineDiagramUpdater
				.getCollectionTaskCollectionTaskImportOperationsCompartment_7001SemanticChildren(
