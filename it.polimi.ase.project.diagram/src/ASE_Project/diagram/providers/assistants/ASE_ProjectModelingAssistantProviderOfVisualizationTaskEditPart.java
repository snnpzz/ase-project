 ...
 * @generated
 */
public class ASE_ProjectModelingAssistantProviderOfVisualizationTaskEditPart
	...
	*/
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((ASE_Project.diagram.edit.parts.VisualizationTaskEditPart) sourceEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnSource(ASE_Project.diagram.edit.parts.VisualizationTaskEditPart source) {
	...
	*/
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source, IAdaptable target) {
		...
		return doGetRelTypesOnSourceAndTarget((ASE_Project.diagram.edit.parts.VisualizationTaskEditPart) sourceEditPart,
				targetEditPart);
	}
	...
	*/
	public List<IElementType> doGetRelTypesOnSourceAndTarget(
			ASE_Project.diagram.edit.parts.VisualizationTaskEditPart source, IGraphicalEditPart targetEditPart) {
	...
	*/
	...
	public List<IElementType> getTypesForTarget(IAdaptable source, IElementType relationshipType) {
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((ASE_Project.diagram.edit.parts.VisualizationTaskEditPart) sourceEditPart,
				relationshipType);
	}
	...
	* @generated
	*/
	public List<IElementType> doGetTypesForTarget(ASE_Project.diagram.edit.parts.VisualizationTaskEditPart source,
	...
	*/
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((ASE_Project.diagram.edit.parts.VisualizationTaskEditPart) targetEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnTarget(ASE_Project.diagram.edit.parts.VisualizationTaskEditPart target) {
		List<IElementType> types = new ArrayList<IElementType>(1);
		types.add(ASE_Project.diagram.providers.ASE_ProjectElementTypes.Dataflow_4001);
		return types;
	}
	...
	*/
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((ASE_Project.diagram.edit.parts.VisualizationTaskEditPart) targetEditPart,
				relationshipType);
	}
	...
	* @generated
	*/
	public List<IElementType> doGetTypesForSource(ASE_Project.diagram.edit.parts.VisualizationTaskEditPart target,
			IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
		if (relationshipType == ASE_Project.diagram.providers.ASE_ProjectElementTypes.Dataflow_4001) {
			types.add(ASE_Project.diagram.providers.ASE_ProjectElementTypes.CollectionTask_2001);
