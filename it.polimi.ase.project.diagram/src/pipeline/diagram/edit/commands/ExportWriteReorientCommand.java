 ...
 * @generated
 */
public class ExportWriteReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ExportWriteReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return PipelineBaseItemSemanticEditPolicy.getLinkConstraints().canExistExportWrite_4022(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return PipelineBaseItemSemanticEditPolicy.getLinkConstraints().canExistExportWrite_4022(getOldSource(),
				getNewTarget());
	}
