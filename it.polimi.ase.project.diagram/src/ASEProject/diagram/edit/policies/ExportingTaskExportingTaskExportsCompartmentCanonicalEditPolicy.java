...
public class ExportingTaskExportingTaskExportsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return ASEProject.ASEProjectPackage.eINSTANCE.getExportingTask_Exports();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ASEProject.diagram.part.ASEProjectNodeDescriptor> childDescriptors = ASEProject.diagram.part.ASEProjectDiagramUpdater
				.getExportingTaskExportingTaskExportsCompartment_7008SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return ASEProject.diagram.edit.parts.ExportEditPart.VISUAL_ID == ASEProject.diagram.part.ASEProjectVisualIDRegistry
				.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<ASEProject.diagram.part.ASEProjectNodeDescriptor> childDescriptors = ASEProject.diagram.part.ASEProjectDiagramUpdater
				.getExportingTaskExportingTaskExportsCompartment_7008SemanticChildren((View) getHost().getModel());
