 ...
 * @generated
 */
public class DescriptiveAnalysisOperationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DescriptiveAnalysisOperationNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineParserProvider.getParser(PipelineElementTypes.DescriptiveAnalysisOperation_3065,
					getParserElement(), PipelineVisualIDRegistry
							.getType(pipeline.diagram.edit.parts.DescriptiveAnalysisOperationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
