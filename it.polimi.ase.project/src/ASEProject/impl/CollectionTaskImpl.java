 ...
 * </p>
 * <ul>
 *   <li>{@link ASEProject.impl.CollectionTaskImpl#getImports <em>Imports</em>}</li>
 * </ul>
 *
 * @generated
 */
public class CollectionTaskImpl extends TaskImpl implements CollectionTask {
	...
	protected EClass eStaticClass() {
		return ASEProjectPackage.Literals.COLLECTION_TASK;
	}
	...
	public EList<Import> getImports() {
		if (imports == null) {
			imports = new EObjectContainmentEList<Import>(Import.class, this, ASEProjectPackage.COLLECTION_TASK__IMPORTS);
		}
		return imports;
	}
