...
public class PipelineEditPart extends DiagramEditPart {
	...
	* @generated
	*/
	public final static String MODEL_ID = "ASE_Project"; //$NON-NLS-1$
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ASE_Project.diagram.edit.policies.PipelineItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ASE_Project.diagram.edit.policies.PipelineCanonicalEditPolicy());
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(
							new ASE_Project.diagram.edit.commands.ASE_ProjectCreateShortcutDecorationsCommand(
