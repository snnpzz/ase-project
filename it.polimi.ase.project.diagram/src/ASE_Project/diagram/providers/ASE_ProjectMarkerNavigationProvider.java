 ...
 * @generated
 */
public class ASE_ProjectMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {

	/**
	* @generated
	*/
	public static final String MARKER_TYPE = ASE_Project.diagram.part.ASE_ProjectDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			ASE_Project.diagram.part.ASE_ProjectDiagramEditorUtil.selectElementsInDiagram(editor,
