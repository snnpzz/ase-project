 ...
 * @generated
 */
public class CollectionTaskCollectionTaskImportsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return ASE_Project.ASE_ProjectPackage.eINSTANCE.getCollectionTask_Imports();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ASE_Project.diagram.part.ASE_ProjectNodeDescriptor> childDescriptors = ASE_Project.diagram.part.ASE_ProjectDiagramUpdater
				.getCollectionTaskCollectionTaskImportsCompartment_7001SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return ASE_Project.diagram.edit.parts.ImportEditPart.VISUAL_ID == ASE_Project.diagram.part.ASE_ProjectVisualIDRegistry
				.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<ASE_Project.diagram.part.ASE_ProjectNodeDescriptor> childDescriptors = ASE_Project.diagram.part.ASE_ProjectDiagramUpdater
				.getCollectionTaskCollectionTaskImportsCompartment_7001SemanticChildren((View) getHost().getModel());
