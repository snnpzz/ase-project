...
public class CleaningTaskCleaningTaskOperationsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return ASEProject.ASEProjectPackage.eINSTANCE.getCleaningTask_Operations();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ASEProject.diagram.part.ASEProjectNodeDescriptor> childDescriptors = ASEProject.diagram.part.ASEProjectDiagramUpdater
				.getCleaningTaskCleaningTaskOperationsCompartment_7006SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == ASEProject.diagram.edit.parts.UserDefinedEditPart.VISUAL_ID
				|| visualID == ASEProject.diagram.edit.parts.PredefinedEditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<ASEProject.diagram.part.ASEProjectNodeDescriptor> childDescriptors = ASEProject.diagram.part.ASEProjectDiagramUpdater
				.getCleaningTaskCleaningTaskOperationsCompartment_7006SemanticChildren((View) getHost().getModel());
