 ...
 * @generated
 */
public class ExportExpUsesReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ExportExpUsesReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Schema && newEnd instanceof Export)) {
			return false;
		}
		return PipelineBaseItemSemanticEditPolicy.getLinkConstraints().canExistExportExpUses_4014(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return PipelineBaseItemSemanticEditPolicy.getLinkConstraints().canExistExportExpUses_4014(getOldSource(),
				getNewTarget());
	}
