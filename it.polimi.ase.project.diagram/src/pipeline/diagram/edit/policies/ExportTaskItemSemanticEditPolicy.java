 ...
 * @generated
 */
public class ExportTaskItemSemanticEditPolicy extends PipelineBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public ExportTaskItemSemanticEditPolicy() {
					...
					case ExportEditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (PipelineVisualIDRegistry
									.getVisualID(outgoingLink) == ExportGeneratesEditPart.VISUAL_ID) {
