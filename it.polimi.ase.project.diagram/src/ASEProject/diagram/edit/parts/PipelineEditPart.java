...
public class PipelineEditPart extends DiagramEditPart {
	...
	* @generated
	*/
	public final static String MODEL_ID = "ASEProject"; //$NON-NLS-1$
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ASEProject.diagram.edit.policies.PipelineItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new ASEProject.diagram.edit.policies.PipelineCanonicalEditPolicy());
			...
			private Command createShortcutsCommand(DropObjectsRequest dropRequest,
				...
				if (command != null) {
					return command.chain(new ICommandProxy(
							new ASEProject.diagram.edit.commands.ASEProjectCreateShortcutDecorationsCommand(
