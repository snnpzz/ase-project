 ...
 * @generated
 */
public class ASEProjectModelingAssistantProviderOfVisualizationTaskEditPart
	...
	*/
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((ASEProject.diagram.edit.parts.VisualizationTaskEditPart) sourceEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnSource(ASEProject.diagram.edit.parts.VisualizationTaskEditPart source) {
	...
	*/
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source, IAdaptable target) {
		...
		return doGetRelTypesOnSourceAndTarget((ASEProject.diagram.edit.parts.VisualizationTaskEditPart) sourceEditPart,
				targetEditPart);
	}
	...
	*/
	public List<IElementType> doGetRelTypesOnSourceAndTarget(
			ASEProject.diagram.edit.parts.VisualizationTaskEditPart source, IGraphicalEditPart targetEditPart) {
	...
	*/
	...
	public List<IElementType> getTypesForTarget(IAdaptable source, IElementType relationshipType) {
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((ASEProject.diagram.edit.parts.VisualizationTaskEditPart) sourceEditPart,
				relationshipType);
	}
	...
	* @generated
	*/
	public List<IElementType> doGetTypesForTarget(ASEProject.diagram.edit.parts.VisualizationTaskEditPart source,
	...
	*/
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((ASEProject.diagram.edit.parts.VisualizationTaskEditPart) targetEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnTarget(ASEProject.diagram.edit.parts.VisualizationTaskEditPart target) {
		List<IElementType> types = new ArrayList<IElementType>(1);
		types.add(ASEProject.diagram.providers.ASEProjectElementTypes.Dataflow_4002);
		return types;
	}
	...
	*/
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((ASEProject.diagram.edit.parts.VisualizationTaskEditPart) targetEditPart,
				relationshipType);
	}
	...
	* @generated
	*/
	public List<IElementType> doGetTypesForSource(ASEProject.diagram.edit.parts.VisualizationTaskEditPart target,
			IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
		if (relationshipType == ASEProject.diagram.providers.ASEProjectElementTypes.Dataflow_4002) {
			types.add(ASEProject.diagram.providers.ASEProjectElementTypes.CollectionTask_2007);
