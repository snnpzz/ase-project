...
public class CollectionTaskCollectionTaskImportsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return ASEProject.ASEProjectPackage.eINSTANCE.getCollectionTask_Imports();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ASEProject.diagram.part.ASEProjectNodeDescriptor> childDescriptors = ASEProject.diagram.part.ASEProjectDiagramUpdater
				.getCollectionTaskCollectionTaskImportsCompartment_7005SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return ASEProject.diagram.edit.parts.ImportEditPart.VISUAL_ID == ASEProject.diagram.part.ASEProjectVisualIDRegistry
				.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<ASEProject.diagram.part.ASEProjectNodeDescriptor> childDescriptors = ASEProject.diagram.part.ASEProjectDiagramUpdater
				.getCollectionTaskCollectionTaskImportsCompartment_7005SemanticChildren((View) getHost().getModel());
