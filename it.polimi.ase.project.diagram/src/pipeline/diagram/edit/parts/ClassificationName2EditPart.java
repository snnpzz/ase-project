 ...
 * @generated
 */
public class ClassificationName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ClassificationName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineParserProvider.getParser(PipelineElementTypes.Classification_3043, getParserElement(),
					PipelineVisualIDRegistry
							.getType(pipeline.diagram.edit.parts.ClassificationName2EditPart.VISUAL_ID));
		}
		return parser;
	}
