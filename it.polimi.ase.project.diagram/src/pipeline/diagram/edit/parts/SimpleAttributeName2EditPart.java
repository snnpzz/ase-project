 ...
 * @generated
 */
public class SimpleAttributeName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public SimpleAttributeName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineParserProvider.getParser(PipelineElementTypes.SimpleAttribute_3005, getParserElement(),
					PipelineVisualIDRegistry
							.getType(pipeline.diagram.edit.parts.SimpleAttributeName2EditPart.VISUAL_ID));
		}
		return parser;
	}
