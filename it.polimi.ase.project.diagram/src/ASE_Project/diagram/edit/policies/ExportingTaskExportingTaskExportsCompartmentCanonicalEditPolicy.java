 ...
 * @generated
 */
public class ExportingTaskExportingTaskExportsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return ASE_Project.ASE_ProjectPackage.eINSTANCE.getExportingTask_Exports();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ASE_Project.diagram.part.ASE_ProjectNodeDescriptor> childDescriptors = ASE_Project.diagram.part.ASE_ProjectDiagramUpdater
				.getExportingTaskExportingTaskExportsCompartment_7004SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return ASE_Project.diagram.edit.parts.ExportEditPart.VISUAL_ID == ASE_Project.diagram.part.ASE_ProjectVisualIDRegistry
				.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<ASE_Project.diagram.part.ASE_ProjectNodeDescriptor> childDescriptors = ASE_Project.diagram.part.ASE_ProjectDiagramUpdater
				.getExportingTaskExportingTaskExportsCompartment_7004SemanticChildren((View) getHost().getModel());
