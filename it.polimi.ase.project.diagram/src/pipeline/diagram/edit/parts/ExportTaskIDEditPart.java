 ...
 * @generated
 */
public class ExportTaskIDEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ExportTaskIDEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineParserProvider.getParser(PipelineElementTypes.ExportTask_2032, getParserElement(),
					PipelineVisualIDRegistry.getType(pipeline.diagram.edit.parts.ExportTaskIDEditPart.VISUAL_ID));
		}
		return parser;
	}
