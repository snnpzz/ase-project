 ...
 * @generated
 */
public class ASE_ProjectShortcutsDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	protected class ShortcutsDecorator extends AbstractDecorator {
		...
		*/
		public void refresh() {
			...
			Image image = ASE_Project.diagram.part.ASE_ProjectDiagramEditorPlugin.getInstance()
