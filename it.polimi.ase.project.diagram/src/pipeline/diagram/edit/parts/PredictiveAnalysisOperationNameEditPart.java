 ...
 * @generated
 */
public class PredictiveAnalysisOperationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public PredictiveAnalysisOperationNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineParserProvider.getParser(PipelineElementTypes.PredictiveAnalysisOperation_3006,
					getParserElement(), PipelineVisualIDRegistry
							.getType(pipeline.diagram.edit.parts.PredictiveAnalysisOperationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
