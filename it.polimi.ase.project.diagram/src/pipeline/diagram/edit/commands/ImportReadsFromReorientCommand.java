 ...
 * @generated
 */
public class ImportReadsFromReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ImportReadsFromReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return PipelineBaseItemSemanticEditPolicy.getLinkConstraints().canExistImportReadsFrom_4007(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return PipelineBaseItemSemanticEditPolicy.getLinkConstraints().canExistImportReadsFrom_4007(getOldSource(),
				getNewTarget());
	}
	...
	*/
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setReadsFrom(null);
		getNewSource().setReadsFrom(getOldTarget());
	...
	*/
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setReadsFrom(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
