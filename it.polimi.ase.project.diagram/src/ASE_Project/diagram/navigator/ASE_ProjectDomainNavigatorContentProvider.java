 ...
 * @generated
 */
public class ASE_ProjectDomainNavigatorContentProvider implements ICommonContentProvider {
	...
	* @generated
	*/
	public ASE_ProjectDomainNavigatorContentProvider() {
	...
	*/
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof ASE_Project.diagram.navigator.ASE_ProjectDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier.getChildren(
					((ASE_Project.diagram.navigator.ASE_ProjectDomainNavigatorItem) parentElement).getEObject()),
					parentElement);
		}
		return EMPTY_ARRAY;
	}
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new ASE_Project.diagram.navigator.ASE_ProjectDomainNavigatorItem((EObject) objects[i],
