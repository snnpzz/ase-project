 ...
 * @generated
 */
public class IntegrationTaskIDEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public IntegrationTaskIDEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineParserProvider.getParser(PipelineElementTypes.IntegrationTask_2002, getParserElement(),
					PipelineVisualIDRegistry.getType(pipeline.diagram.edit.parts.IntegrationTaskIDEditPart.VISUAL_ID));
		}
		return parser;
	}
