...
import pipeline.diagram.edit.policies.ExportingTaskItemSemanticEditPolicy;
...
public class ExportingTaskEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE, new ExportingTaskItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ExportingTaskNameEditPart) {
			((ExportingTaskNameEditPart) childEditPart).setLabel(getPrimaryShape().getFigureExportingTaskLabelFigure());
			return true;
		}
		if (childEditPart instanceof ExportingTaskExportingTaskExportsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getExportingTaskExportsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(((ExportingTaskExportingTaskExportsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected boolean removeFixedChild(EditPart childEditPart) {
		...
		if (childEditPart instanceof ExportingTaskExportingTaskExportsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getExportingTaskExportsCompartmentFigure();
			pane.remove(((ExportingTaskExportingTaskExportsCompartmentEditPart) childEditPart).getFigure());
			return true;
		}
		return false;
	}
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ExportingTaskExportingTaskExportsCompartmentEditPart) {
	...
	*/
	public EditPart getPrimaryChildEditPart() {
		return getChildBySemanticHint(PipelineVisualIDRegistry.getType(ExportingTaskNameEditPart.VISUAL_ID));
	}
