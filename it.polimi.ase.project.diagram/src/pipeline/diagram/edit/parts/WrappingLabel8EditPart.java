...
public class WrappingLabel8EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				PipelineVisualIDRegistry.getType(pipeline.diagram.edit.parts.WrappingLabel8EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineParserProvider.getParser(PipelineElementTypes.ChartAxes_4026, getParserElement(),
