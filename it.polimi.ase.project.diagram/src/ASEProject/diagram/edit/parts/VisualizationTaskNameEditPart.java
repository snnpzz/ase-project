...
public class VisualizationTaskNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new ASEProject.diagram.edit.policies.ASEProjectTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return ASEProject.diagram.providers.ASEProjectElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ASEProject.diagram.providers.ASEProjectParserProvider.getParser(
					ASEProject.diagram.providers.ASEProjectElementTypes.VisualizationTask_2011, getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					ASEProject.diagram.edit.parts.ASEProjectEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
