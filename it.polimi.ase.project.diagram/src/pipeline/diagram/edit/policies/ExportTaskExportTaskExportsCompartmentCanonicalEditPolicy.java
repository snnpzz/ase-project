 ...
 * @generated
 */
public class ExportTaskExportTaskExportsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PipelinePackage.eINSTANCE.getExportTask_Exports();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineNodeDescriptor> childDescriptors = PipelineDiagramUpdater
				.getExportTaskExportTaskExportsCompartment_7022SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineNodeDescriptor> childDescriptors = PipelineDiagramUpdater
				.getExportTaskExportTaskExportsCompartment_7022SemanticChildren((View) getHost().getModel());
