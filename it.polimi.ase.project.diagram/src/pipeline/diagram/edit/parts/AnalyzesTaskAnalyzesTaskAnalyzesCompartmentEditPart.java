...
import pipeline.diagram.edit.policies.AnalyzesTaskAnalyzesTaskAnalyzesCompartmentCanonicalEditPolicy;
import pipeline.diagram.edit.policies.AnalyzesTaskAnalyzesTaskAnalyzesCompartmentItemSemanticEditPolicy;
...
public class AnalyzesTaskAnalyzesTaskAnalyzesCompartmentEditPart extends ShapeCompartmentEditPart {
	...
	*/
	public String getCompartmentName() {
		return Messages.AnalyzesTaskAnalyzesTaskAnalyzesCompartmentEditPart_title;
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new AnalyzesTaskAnalyzesTaskAnalyzesCompartmentItemSemanticEditPolicy());
		installEditPolicy(EditPolicyRoles.CREATION_ROLE,
				new CreationEditPolicyWithCustomReparent(PipelineVisualIDRegistry.TYPED_INSTANCE));
		installEditPolicy(EditPolicyRoles.DRAG_DROP_ROLE, new DragDropEditPolicy());
		installEditPolicy(EditPolicyRoles.CANONICAL_ROLE,
				new AnalyzesTaskAnalyzesTaskAnalyzesCompartmentCanonicalEditPolicy());
	}
