 ...
 * @generated
 */
public class ImportImpUsesReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public ImportImpUsesReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		if (!(oldEnd instanceof Schema && newEnd instanceof Import)) {
			return false;
		}
		return PipelineBaseItemSemanticEditPolicy.getLinkConstraints().canExistImportImpUses_4013(getNewSource(),
				getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return PipelineBaseItemSemanticEditPolicy.getLinkConstraints().canExistImportImpUses_4013(getOldSource(),
				getNewTarget());
	}
