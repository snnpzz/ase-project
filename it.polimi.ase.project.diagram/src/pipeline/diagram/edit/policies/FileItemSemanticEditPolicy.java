 ...
 * @generated
 */
public class FileItemSemanticEditPolicy extends PipelineBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public FileItemSemanticEditPolicy() {
		super(PipelineElementTypes.File_2008);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (PipelineVisualIDRegistry.getVisualID(incomingLink) == ExportOperationWriteEditPart.VISUAL_ID) {
