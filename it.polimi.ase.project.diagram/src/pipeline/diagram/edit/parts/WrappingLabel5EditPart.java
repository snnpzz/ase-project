...
public class WrappingLabel5EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				PipelineVisualIDRegistry.getType(pipeline.diagram.edit.parts.WrappingLabel5EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineParserProvider.getParser(PipelineElementTypes.ImportOperationUse_4007, getParserElement(),
