...
public class CleaningTaskEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ASE_Project.diagram.edit.policies.CleaningTaskItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ASE_Project.diagram.edit.parts.CleaningTaskNameEditPart) {
			((ASE_Project.diagram.edit.parts.CleaningTaskNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureCleaningTaskLabelFigure());
			return true;
		}
		if (childEditPart instanceof ASE_Project.diagram.edit.parts.CleaningTaskCleaningTaskOperationsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getCleaningTaskOperationsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(
					((ASE_Project.diagram.edit.parts.CleaningTaskCleaningTaskOperationsCompartmentEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ASE_Project.diagram.edit.parts.CleaningTaskCleaningTaskOperationsCompartmentEditPart) {
