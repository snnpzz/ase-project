 ...
 * 
 */
package ASE_Project.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(ASE_Project.diagram.part.ASE_ProjectDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(ASE_Project.diagram.part.Messages.MessageFormatParser_InvalidInputError,
