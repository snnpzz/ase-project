 ...
 * @generated
 */
public class ASEProjectModelingAssistantProviderOfIntegrationTaskEditPart
	...
	*/
	...
	public List<IElementType> getRelTypesOnSource(IAdaptable source) {
		...
		return doGetRelTypesOnSource((ASEProject.diagram.edit.parts.IntegrationTaskEditPart) sourceEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnSource(ASEProject.diagram.edit.parts.IntegrationTaskEditPart source) {
	...
	*/
	...
	public List<IElementType> getRelTypesOnSourceAndTarget(IAdaptable source, IAdaptable target) {
		...
		return doGetRelTypesOnSourceAndTarget((ASEProject.diagram.edit.parts.IntegrationTaskEditPart) sourceEditPart,
				targetEditPart);
	}
	...
	*/
	public List<IElementType> doGetRelTypesOnSourceAndTarget(
			ASEProject.diagram.edit.parts.IntegrationTaskEditPart source, IGraphicalEditPart targetEditPart) {
	...
	*/
	...
	public List<IElementType> getTypesForTarget(IAdaptable source, IElementType relationshipType) {
		IGraphicalEditPart sourceEditPart = (IGraphicalEditPart) source.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForTarget((ASEProject.diagram.edit.parts.IntegrationTaskEditPart) sourceEditPart,
				relationshipType);
	}
	...
	* @generated
	*/
	public List<IElementType> doGetTypesForTarget(ASEProject.diagram.edit.parts.IntegrationTaskEditPart source,
	...
	*/
	...
	public List<IElementType> getRelTypesOnTarget(IAdaptable target) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetRelTypesOnTarget((ASEProject.diagram.edit.parts.IntegrationTaskEditPart) targetEditPart);
	}

	/**
	* @generated
	*/
	public List<IElementType> doGetRelTypesOnTarget(ASEProject.diagram.edit.parts.IntegrationTaskEditPart target) {
		List<IElementType> types = new ArrayList<IElementType>(1);
		types.add(ASEProject.diagram.providers.ASEProjectElementTypes.Dataflow_4002);
		return types;
	}
	...
	*/
	...
	public List<IElementType> getTypesForSource(IAdaptable target, IElementType relationshipType) {
		IGraphicalEditPart targetEditPart = (IGraphicalEditPart) target.getAdapter(IGraphicalEditPart.class);
		return doGetTypesForSource((ASEProject.diagram.edit.parts.IntegrationTaskEditPart) targetEditPart,
				relationshipType);
	}
	...
	* @generated
	*/
	public List<IElementType> doGetTypesForSource(ASEProject.diagram.edit.parts.IntegrationTaskEditPart target,
			IElementType relationshipType) {
		List<IElementType> types = new ArrayList<IElementType>();
		if (relationshipType == ASEProject.diagram.providers.ASEProjectElementTypes.Dataflow_4002) {
			types.add(ASEProject.diagram.providers.ASEProjectElementTypes.CollectionTask_2007);
