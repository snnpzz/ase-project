 ...
 * @generated
 */
public class CollectionTaskNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CollectionTaskNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ASE_Project.diagram.providers.ASE_ProjectParserProvider.getParser(
					ASE_Project.diagram.providers.ASE_ProjectElementTypes.CollectionTask_2001, getParserElement(),
