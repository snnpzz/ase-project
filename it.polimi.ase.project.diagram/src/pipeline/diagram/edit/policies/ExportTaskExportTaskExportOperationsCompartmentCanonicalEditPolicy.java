 ...
 * @generated
 */
public class ExportTaskExportTaskExportOperationsCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PipelinePackage.eINSTANCE.getExportTask_ExportOperations();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineNodeDescriptor> childDescriptors = PipelineDiagramUpdater
				.getExportTaskExportTaskExportOperationsCompartment_7004SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return ExportOperationEditPart.VISUAL_ID == PipelineVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineNodeDescriptor> childDescriptors = PipelineDiagramUpdater
				.getExportTaskExportTaskExportOperationsCompartment_7004SemanticChildren((View) getHost().getModel());
