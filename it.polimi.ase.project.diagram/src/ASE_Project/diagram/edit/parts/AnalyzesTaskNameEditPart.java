 ...
 * @generated
 */
public class AnalyzesTaskNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public AnalyzesTaskNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ASE_Project.diagram.providers.ASE_ProjectParserProvider.getParser(
					ASE_Project.diagram.providers.ASE_ProjectElementTypes.AnalyzesTask_2004, getParserElement(),
