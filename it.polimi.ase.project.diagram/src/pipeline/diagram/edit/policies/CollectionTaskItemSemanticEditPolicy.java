 ...
 * @generated
 */
public class CollectionTaskItemSemanticEditPolicy extends PipelineBaseItemSemanticEditPolicy {
					...
					case ImportOperationEditPart.VISUAL_ID:
						for (Iterator<?> it = cnode.getSourceEdges().iterator(); it.hasNext();) {
							...
							if (PipelineVisualIDRegistry
									.getVisualID(outgoingLink) == ImportOperationReadEditPart.VISUAL_ID) {
