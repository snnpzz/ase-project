 ...
 * @generated
 */
public class AttributeAttributeAttributesCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PipelinePackage.eINSTANCE.getAttribute_Attributes();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineNodeDescriptor> childDescriptors = PipelineDiagramUpdater
				.getAttributeAttributeAttributesCompartment_7025SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		return Attribute2EditPart.VISUAL_ID == PipelineVisualIDRegistry.getVisualID(view);
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineNodeDescriptor> childDescriptors = PipelineDiagramUpdater
				.getAttributeAttributeAttributesCompartment_7025SemanticChildren((View) getHost().getModel());
