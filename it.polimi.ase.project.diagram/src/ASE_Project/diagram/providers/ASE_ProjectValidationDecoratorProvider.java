 ...
 * @generated
 */
public class ASE_ProjectValidationDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	* @generated
	*/
	private static final String MARKER_TYPE = ASE_Project.diagram.part.ASE_ProjectDiagramEditorPlugin.ID
	...
	*/
	public void createDecorators(IDecoratorTarget decoratorTarget) {
		...
		if (editPart instanceof GraphicalEditPart || editPart instanceof AbstractConnectionEditPart) {
			...
			if (((DiagramEditDomain) ed).getEditorPart() instanceof ASE_Project.diagram.part.ASE_ProjectDiagramEditor) {
	...
	*/
	public boolean provides(IOperation operation) {
		...
		return view != null && ASE_Project.diagram.edit.parts.PipelineEditPart.MODEL_ID
		...
		*/
		public StatusDecorator(IDecoratorTarget decoratorTarget) {
			...
			try {
				...
				ASE_Project.diagram.part.ASE_ProjectDiagramEditorPlugin.getInstance().logError("ViewID access failure", //$NON-NLS-1$
						e);
			}
		}
