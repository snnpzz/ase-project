 ...
 * @generated
 */
public class AnalyzesTaskAnalyzesTaskAnalyzesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return ASE_Project.ASE_ProjectPackage.eINSTANCE.getAnalyzesTask_Analyzes();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ASE_Project.diagram.part.ASE_ProjectNodeDescriptor> childDescriptors = ASE_Project.diagram.part.ASE_ProjectDiagramUpdater
				.getAnalyzesTaskAnalyzesTaskAnalyzesCompartment_7003SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<ASE_Project.diagram.part.ASE_ProjectNodeDescriptor> childDescriptors = ASE_Project.diagram.part.ASE_ProjectDiagramUpdater
				.getAnalyzesTaskAnalyzesTaskAnalyzesCompartment_7003SemanticChildren((View) getHost().getModel());
