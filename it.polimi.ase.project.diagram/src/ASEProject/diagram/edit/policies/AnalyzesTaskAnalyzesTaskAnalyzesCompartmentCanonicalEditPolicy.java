...
public class AnalyzesTaskAnalyzesTaskAnalyzesCompartmentCanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return ASEProject.ASEProjectPackage.eINSTANCE.getAnalyzesTask_Analyzes();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<ASEProject.diagram.part.ASEProjectNodeDescriptor> childDescriptors = ASEProject.diagram.part.ASEProjectDiagramUpdater
				.getAnalyzesTaskAnalyzesTaskAnalyzesCompartment_7007SemanticChildren(viewObject);
	...
	*/
	protected void refreshSemantic() {
		...
		List<ASEProject.diagram.part.ASEProjectNodeDescriptor> childDescriptors = ASEProject.diagram.part.ASEProjectDiagramUpdater
				.getAnalyzesTaskAnalyzesTaskAnalyzesCompartment_7007SemanticChildren((View) getHost().getModel());
