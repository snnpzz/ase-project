 ...
 * @generated
 */
public class InternalDataFlowSchemaReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public InternalDataFlowSchemaReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return PipelineBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistInternalDataFlowSchema_4020(getNewSource(), getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return PipelineBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistInternalDataFlowSchema_4020(getOldSource(), getNewTarget());
	}
