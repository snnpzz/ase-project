 ...
 * @generated
 */
public class ImportOperationIDEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ImportOperationIDEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineParserProvider.getParser(PipelineElementTypes.ImportOperation_3013, getParserElement(),
					PipelineVisualIDRegistry.getType(pipeline.diagram.edit.parts.ImportOperationIDEditPart.VISUAL_ID));
		}
		return parser;
	}
