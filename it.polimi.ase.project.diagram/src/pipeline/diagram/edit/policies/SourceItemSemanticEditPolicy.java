 ...
 * @generated
 */
public class SourceItemSemanticEditPolicy extends PipelineBaseItemSemanticEditPolicy {

	/**
	* @generated
	*/
	public SourceItemSemanticEditPolicy() {
		super(PipelineElementTypes.Source_2007);
	}
	...
	*/
	protected Command getDestroyElementCommand(DestroyElementRequest req) {
		...
		for (Iterator<?> it = view.getTargetEdges().iterator(); it.hasNext();) {
			...
			if (PipelineVisualIDRegistry.getVisualID(incomingLink) == ImportOperationReadEditPart.VISUAL_ID) {
