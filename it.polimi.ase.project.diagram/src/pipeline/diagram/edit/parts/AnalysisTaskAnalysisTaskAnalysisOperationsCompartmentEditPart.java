	...
	*/
	public EditPart getTargetEditPart(Request request) {
		if (request instanceof CreateViewAndElementRequest) {
			...
			if (type == PipelineElementTypes.DescriptiveAnalysisOperation_3004) {
				return this;
			}
			if (type == PipelineElementTypes.ClassificationAnalysisOperation_3005) {
				return this;
			}
			if (type == PipelineElementTypes.PredictiveAnalysisOperation_3006) {
				return this;
			}
			if (type == PipelineElementTypes.ClusteringAnalysisOperation_3007) {
				return this;
			}
			...
			if (RequestConstants.REQ_CONNECTION_END.equals(request.getType())) {
				for (Object type : ((CreateUnspecifiedTypeConnectionRequest) request).getElementTypes()) {
					if (type instanceof IElementType) {
						...
						if (elementType.equals(PipelineElementTypes.InternalDataFlow_4002))
