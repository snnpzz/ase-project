 ...
 * 
 */
package ASEProject.diagram.parsers;
...
public class MessageFormatParser extends AbstractAttributeParser {
	...
	*/
	public IParserEditStatus isValidEditString(IAdaptable adapter, String editString) {
		...
		if (values == null) {
			return new ParserEditStatus(ASEProject.diagram.part.ASEProjectDiagramEditorPlugin.ID,
					IParserEditStatus.UNEDITABLE,
					NLS.bind(ASEProject.diagram.part.Messages.MessageFormatParser_InvalidInputError,
