...
import pipeline.diagram.edit.policies.PipelineTextSelectionEditPolicy;
 ...
 * @generated
 */
public class ClassificationAnalysisOperationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ClassificationAnalysisOperationNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE, new PipelineTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return PipelineElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineParserProvider.getParser(PipelineElementTypes.ClassificationAnalysisOperation_3066,
					getParserElement(), PipelineVisualIDRegistry.getType(
							pipeline.diagram.edit.parts.ClassificationAnalysisOperationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
