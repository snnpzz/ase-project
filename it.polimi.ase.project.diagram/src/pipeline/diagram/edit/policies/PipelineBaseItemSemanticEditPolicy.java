 ...
 * @generated
 */
public class PipelineBaseItemSemanticEditPolicy extends SemanticEditPolicy {
	...
	* @generated
	*/
	protected PipelineBaseItemSemanticEditPolicy(IElementType elementType) {
	...
	public Command getCommand(Request request) {
		if (request instanceof ReconnectRequest) {
			...
			if (view instanceof View) {
				Integer id = new Integer(PipelineVisualIDRegistry.getVisualID((View) view));
	...
	*/
	private IElementType getContextElementType(IEditCommandRequest request) {
		IElementType requestContextElementType = PipelineElementTypes.getElementType(getVisualID(request));
	...
	*/
	public static LinkConstraints getLinkConstraints() {
		LinkConstraints cached = PipelineDiagramEditorPlugin.getInstance().getLinkConstraints();
		if (cached == null) {
			PipelineDiagramEditorPlugin.getInstance().setLinkConstraints(cached = new LinkConstraints());
		}
		return cached;
	}
	...
	public static class LinkConstraints {
		...
		*/
		 ...
		 * @generated
		 */
		public boolean canCreateInternalDataFlow_4002(Pipeline container, Operation source, Operation target) {
			return canExistInternalDataFlow_4002(container, null, source, target);
		}

		/**
		 * @generated
		 */
		public boolean canCreateDataFlowSchema_4003(DataFlow source, Schema target) {
			if (source != null) {
			...
			return canExistDataFlowSchema_4003(source, target);
		}
		 ...
		 * @generated
		 */
		public boolean canCreateChartAxes_4010(Chart source, SimpleAttribute target) {
			if (source != null) {
			...
			return canExistChartAxes_4010(source, target);
		}
		...
		* @generated
		*/
		public boolean canExistInternalDataFlow_4002(Pipeline container, InternalDataFlow linkInstance,
		...
		* @generated
		*/
		public boolean canExistDataFlowSchema_4003(DataFlow source, Schema target) {
			return true;
		}
		...
		* @generated
		*/
		public boolean canExistChartAxes_4010(Chart source, SimpleAttribute target) {
			return true;
		}
	}
