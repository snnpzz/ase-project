 ...
 * @generated
 */
public class ImportNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ImportNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ASE_Project.diagram.providers.ASE_ProjectParserProvider.getParser(
					ASE_Project.diagram.providers.ASE_ProjectElementTypes.Import_3001, getParserElement(),
