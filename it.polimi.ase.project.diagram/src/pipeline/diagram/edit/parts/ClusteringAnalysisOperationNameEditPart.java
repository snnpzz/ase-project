 ...
 * @generated
 */
public class ClusteringAnalysisOperationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ClusteringAnalysisOperationNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineParserProvider.getParser(PipelineElementTypes.ClusteringAnalysisOperation_3055,
					getParserElement(), PipelineVisualIDRegistry
							.getType(pipeline.diagram.edit.parts.ClusteringAnalysisOperationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
