...
/**
 * This is the item provider adapter for a {@link pipeline.AnalysisTask} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class AnalysisTaskItemProvider extends TaskItemProvider {
	/**
	 ...
	 * @generated
	 */
	public AnalysisTaskItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/AnalysisTask"));
	}
	...
	public String getText(Object object) {
		String label = ((AnalysisTask)object).getID();
		return label == null || label.length() == 0 ?
			getString("_UI_AnalysisTask_type") :
			getString("_UI_AnalysisTask_type") + " " + label;
	}
