 ...
 * @generated
 */
public class ASEProjectMarkerNavigationProvider extends AbstractModelMarkerNavigationProvider {

	/**
	* @generated
	*/
	public static final String MARKER_TYPE = ASEProject.diagram.part.ASEProjectDiagramEditorPlugin.ID + ".diagnostic"; //$NON-NLS-1$
	...
	*/
	protected void doGotoMarker(IMarker marker) {
		...
		if (targetEditPart != null) {
			ASEProject.diagram.part.ASEProjectDiagramEditorUtil.selectElementsInDiagram(editor,
