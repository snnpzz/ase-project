 ...
 * @generated
 */
public class CollectionTaskIDEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public CollectionTaskIDEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineParserProvider.getParser(PipelineElementTypes.CollectionTask_2001, getParserElement(),
					PipelineVisualIDRegistry.getType(pipeline.diagram.edit.parts.CollectionTaskIDEditPart.VISUAL_ID));
		}
		return parser;
	}
