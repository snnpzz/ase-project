 ...
 * </p>
 * <ul>
 *   <li>{@link ASEProject.impl.ImportImpl#getReadsFrom <em>Reads From</em>}</li>
 *   <li>{@link ASEProject.impl.ImportImpl#getUses <em>Uses</em>}</li>
 *   <li>{@link ASEProject.impl.ImportImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImportImpl extends EObjectImpl implements Import {
	...
	protected EClass eStaticClass() {
		return ASEProjectPackage.Literals.IMPORT;
	}
		...
		if (readsFrom != null && readsFrom.eIsProxy()) {
			...
			if (readsFrom != oldReadsFrom) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ASEProjectPackage.IMPORT__READS_FROM, oldReadsFrom, readsFrom));
			}
		}
		return readsFrom;
	}
	...
	public NotificationChain basicSetReadsFrom(Source newReadsFrom, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, ASEProjectPackage.IMPORT__READS_FROM, oldReadsFrom, newReadsFrom);
	...
	public void setReadsFrom(Source newReadsFrom) {
		if (newReadsFrom != readsFrom) {
			...
			if (readsFrom != null)
				msgs = ((InternalEObject)readsFrom).eInverseRemove(this, ASEProjectPackage.SOURCE__LINKED_TO, Source.class, msgs);
			if (newReadsFrom != null)
				msgs = ((InternalEObject)newReadsFrom).eInverseAdd(this, ASEProjectPackage.SOURCE__LINKED_TO, Source.class, msgs);
			msgs = basicSetReadsFrom(newReadsFrom, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ASEProjectPackage.IMPORT__READS_FROM, newReadsFrom, newReadsFrom));
	}
	...
	public Schema getUses() {
		if (uses != null && uses.eIsProxy()) {
			...
			if (uses != oldUses) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, ASEProjectPackage.IMPORT__USES, oldUses, uses));
			}
		}
		return uses;
	}
	...
	public void setUses(Schema newUses) {
		...
		uses = newUses;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ASEProjectPackage.IMPORT__USES, oldUses, uses));
	}
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ASEProjectPackage.IMPORT__NAME, oldName, name));
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ASEProjectPackage.IMPORT__READS_FROM:
				if (readsFrom != null)
					msgs = ((InternalEObject)readsFrom).eInverseRemove(this, ASEProjectPackage.SOURCE__LINKED_TO, Source.class, msgs);
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ASEProjectPackage.IMPORT__USES:
				if (resolve) return getUses();
				return basicGetUses();
			case ASEProjectPackage.IMPORT__NAME:
				return getName();
		}
