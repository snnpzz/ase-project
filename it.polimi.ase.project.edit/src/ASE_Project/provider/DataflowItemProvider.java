...
/**
 * This is the item provider adapter for a {@link ASE_Project.Dataflow} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DataflowItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ASE_ProjectPackage.Literals.DATAFLOW__FORMAT,
				 true,
				 false,
				 false,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ASE_ProjectPackage.Literals.DATAFLOW__TARGET,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ASE_ProjectPackage.Literals.DATAFLOW__SOURCE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ASE_ProjectPackage.Literals.DATAFLOW__SCHEMA);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Dataflow.class)) {
			case ASE_ProjectPackage.DATAFLOW__FORMAT:
				fireNotifyChanged(new ViewerNotification(notification, notification.getNotifier(), false, true));
				return;
			case ASE_ProjectPackage.DATAFLOW__SCHEMA:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ASE_ProjectPackage.Literals.DATAFLOW__SCHEMA,
