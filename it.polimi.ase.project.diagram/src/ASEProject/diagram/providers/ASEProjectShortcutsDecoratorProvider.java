 ...
 * @generated
 */
public class ASEProjectShortcutsDecoratorProvider extends AbstractProvider implements IDecoratorProvider {
	...
	protected class ShortcutsDecorator extends AbstractDecorator {
		...
		*/
		public void refresh() {
			...
			Image image = ASEProject.diagram.part.ASEProjectDiagramEditorPlugin.getInstance()
