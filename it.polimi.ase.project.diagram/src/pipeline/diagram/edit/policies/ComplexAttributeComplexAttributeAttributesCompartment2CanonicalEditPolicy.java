 ...
 * @generated
 */
public class ComplexAttributeComplexAttributeAttributesCompartment2CanonicalEditPolicy extends CanonicalEditPolicy {
	...
	*/
	protected EStructuralFeature getFeatureToSynchronize() {
		return PipelinePackage.eINSTANCE.getComplexAttribute_Attributes();
	}
	...
	*/
	...
	protected List getSemanticChildrenList() {
		...
		List<PipelineNodeDescriptor> childDescriptors = PipelineDiagramUpdater
				.getComplexAttributeComplexAttributeAttributesCompartment_7007SemanticChildren(viewObject);
	...
	*/
	private boolean isMyDiagramElement(View view) {
		...
		return visualID == SimpleAttribute2EditPart.VISUAL_ID || visualID == ComplexAttribute2EditPart.VISUAL_ID;
	}
	...
	*/
	protected void refreshSemantic() {
		...
		List<PipelineNodeDescriptor> childDescriptors = PipelineDiagramUpdater
				.getComplexAttributeComplexAttributeAttributesCompartment_7007SemanticChildren(
