 ...
 * @generated
 */
public class ClusteringName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ClusteringName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineParserProvider.getParser(PipelineElementTypes.Clustering_3036, getParserElement(),
					PipelineVisualIDRegistry.getType(pipeline.diagram.edit.parts.ClusteringName2EditPart.VISUAL_ID));
		}
		return parser;
	}
