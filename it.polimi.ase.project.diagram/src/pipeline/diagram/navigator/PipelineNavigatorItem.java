		...
		Platform.getAdapterManager().registerAdapters(new IAdapterFactory() {
			...
			public Object getAdapter(Object adaptableObject, Class adapterType) {
				if (adaptableObject instanceof pipeline.diagram.navigator.PipelineNavigatorItem
					...
					return ((pipeline.diagram.navigator.PipelineNavigatorItem) adaptableObject).getView();
				}
				return null;
			}
	...
	public boolean equals(Object obj) {
		if (obj instanceof pipeline.diagram.navigator.PipelineNavigatorItem) {
			return EcoreUtil.getURI(getView())
					.equals(EcoreUtil.getURI(((pipeline.diagram.navigator.PipelineNavigatorItem) obj).getView()));
		}
