 ...
 * @generated
 */
public class InternalDataFlowIntDFschemaReorientCommand extends EditElementCommand {
	...
	* @generated
	*/
	public InternalDataFlowIntDFschemaReorientCommand(ReorientReferenceRelationshipRequest request) {
	...
	*/
	protected boolean canReorientSource() {
		...
		return PipelineBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistInternalDataFlowIntDFschema_4018(getNewSource(), getOldTarget());
	}
	...
	*/
	protected boolean canReorientTarget() {
		...
		return PipelineBaseItemSemanticEditPolicy.getLinkConstraints()
				.canExistInternalDataFlowIntDFschema_4018(getOldSource(), getNewTarget());
	}
	...
	*/
	protected CommandResult reorientSource() throws ExecutionException {
		getOldSource().setIntDFschema(null);
		getNewSource().setIntDFschema(getOldTarget());
	...
	*/
	protected CommandResult reorientTarget() throws ExecutionException {
		getOldSource().setIntDFschema(getNewTarget());
		return CommandResult.newOKCommandResult(referenceOwner);
	}
