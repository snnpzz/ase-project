 ...
 * @generated
 */
public class DescriptiveNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public DescriptiveNameEditPart(View view) {
		super(view);
	}
	...
	public IParser getParser() {
		if (parser == null) {
			parser = ASE_Project.diagram.providers.ASE_ProjectParserProvider.getParser(
					ASE_Project.diagram.providers.ASE_ProjectElementTypes.Descriptive_3004, getParserElement(),
