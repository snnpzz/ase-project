 ...
 * @generated
 */
public class ComplexAttributeName2EditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public ComplexAttributeName2EditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineParserProvider.getParser(PipelineElementTypes.ComplexAttribute_3012, getParserElement(),
					PipelineVisualIDRegistry
							.getType(pipeline.diagram.edit.parts.ComplexAttributeName2EditPart.VISUAL_ID));
		}
		return parser;
	}
