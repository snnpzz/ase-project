...
public class CleaningTaskEditPart extends ShapeNodeEditPart {
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicyRoles.SEMANTIC_ROLE,
				new ASEProject.diagram.edit.policies.CleaningTaskItemSemanticEditPolicy());
	...
	*/
	protected boolean addFixedChild(EditPart childEditPart) {
		if (childEditPart instanceof ASEProject.diagram.edit.parts.CleaningTaskNameEditPart) {
			((ASEProject.diagram.edit.parts.CleaningTaskNameEditPart) childEditPart)
					.setLabel(getPrimaryShape().getFigureCleaningTaskLabelFigure());
			return true;
		}
		if (childEditPart instanceof ASEProject.diagram.edit.parts.CleaningTaskCleaningTaskOperationsCompartmentEditPart) {
			IFigure pane = getPrimaryShape().getCleaningTaskOperationsCompartmentFigure();
			setupContentPane(pane); // FIXME each comparment should handle his content pane in his own way 
			pane.add(
					((ASEProject.diagram.edit.parts.CleaningTaskCleaningTaskOperationsCompartmentEditPart) childEditPart)
							.getFigure());
			return true;
		}
		return false;
	...
	*/
	protected IFigure getContentPaneFor(IGraphicalEditPart editPart) {
		if (editPart instanceof ASEProject.diagram.edit.parts.CleaningTaskCleaningTaskOperationsCompartmentEditPart) {
