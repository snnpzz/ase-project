...
/**
 * This is the item provider adapter for a {@link pipeline.UserDefined} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class UserDefinedItemProvider extends CleaningOperationItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_UserDefined_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_UserDefined_name_feature", "_UI_UserDefined_type"),
				 PipelinePackage.Literals.USER_DEFINED__NAME,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((UserDefined)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_UserDefined_type") :
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(UserDefined.class)) {
			case PipelinePackage.USER_DEFINED__NAME:
