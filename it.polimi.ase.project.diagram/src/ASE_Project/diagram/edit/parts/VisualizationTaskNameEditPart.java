 ...
 * @generated
 */
public class VisualizationTaskNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public VisualizationTaskNameEditPart(View view) {
		super(view);
	}
	...
	*/
	protected void createDefaultEditPolicies() {
		...
		installEditPolicy(EditPolicy.SELECTION_FEEDBACK_ROLE,
				new ASE_Project.diagram.edit.policies.ASE_ProjectTextSelectionEditPolicy());
	...
	*/
	protected Image getLabelIcon() {
		...
		return ASE_Project.diagram.providers.ASE_ProjectElementTypes.getImage(parserElement.eClass());
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = ASE_Project.diagram.providers.ASE_ProjectParserProvider.getParser(
					ASE_Project.diagram.providers.ASE_ProjectElementTypes.VisualizationTask_2005, getParserElement(),
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, null,
					ASE_Project.diagram.edit.parts.ASE_ProjectEditPartFactory.getTextCellEditorLocator(this)));
		}
		return manager;
	}
