...
public class WrappingLabel3EditPart extends LabelEditPart implements ITextAwareEditPart {
	...
	*/
	static {
		registerSnapBackPosition(
				PipelineVisualIDRegistry.getType(pipeline.diagram.edit.parts.WrappingLabel3EditPart.VISUAL_ID),
				new Point(0, 40));
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineParserProvider.getParser(PipelineElementTypes.ImportOperationRead_4006, getParserElement(),
