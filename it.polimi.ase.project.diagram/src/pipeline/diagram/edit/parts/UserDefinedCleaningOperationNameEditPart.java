 ...
 * @generated
 */
public class UserDefinedCleaningOperationNameEditPart extends CompartmentEditPart implements ITextAwareEditPart {
	...
	* @generated
	*/
	public UserDefinedCleaningOperationNameEditPart(View view) {
		super(view);
	}
	...
	*/
	public IParser getParser() {
		if (parser == null) {
			parser = PipelineParserProvider.getParser(PipelineElementTypes.UserDefinedCleaningOperation_3063,
					getParserElement(), PipelineVisualIDRegistry
							.getType(pipeline.diagram.edit.parts.UserDefinedCleaningOperationNameEditPart.VISUAL_ID));
		}
		return parser;
	}
